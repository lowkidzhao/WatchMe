...
<template>
  <main class="main-container">
    <v-skeleton-loader v-if="store2.showWaiting" elevation="12" type="image"
      style="width: 100%;height: 100%;"></v-skeleton-loader>
    <div v-if="!store2.showWaiting" class="info-container">
      <!-- 系统信息 -->
